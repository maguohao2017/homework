var vacation = {
    ...
    init:function(){
        ...
        var table = new BSTable(vacation.id, "/vacation/list_staff", defaultColunms);
    ...
    add:function(){
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/vacation/vacation_add_staff'
        });
    ...
    edit:function(){
        if (this.check()) {
            var index = layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: Feng.ctxPath + '/vacation/vacation_edit_staff/' + this.seItem.id
            });
            this.layerIndex = index;
        }
    },
    ...
    delete:function(){
        if (this.check()) {
            var operation = function(){
                ...
                var ajax = new $ax(Feng.ctxPath + "/vacation/delete_staff/"+id, function () {
                    Feng.success("删除成功!");
