...
## 管理员后台管理系统功能
1.用户管理 2.角色管理 3.组织管理 4.菜单管理 (5.字典管理 6.业务日志 7.登录日志 8.监控管理 9.通知管理 10.代码生成 )5-10已隐藏，如有需要在菜单管理里设置显示

## 老师管理系统功能
1.个人信息 2.管理班级 3.作业通知 4.作业管理 5.批改作业 

## 学生管理系统功能
1.个人信息 2.班级信息 3.作业通知 4.作业查看 5.成绩查询 6.提交作业
